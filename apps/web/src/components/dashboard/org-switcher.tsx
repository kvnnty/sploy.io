  ...
  return (
    <>
      ...
      <select
        ...
        className="w-full rounded-lg border border-white/10 bg-white/5 px-2 py-1.5 text-xs text-foreground outline-none focus-visible:border-ring focus-visible:ring-2 focus-visible:ring-ring/50"
      >
        {orgs.map((o) => (
